package com.pawis.kafkatutorial.kafka_course.twitter;
...
public class TwitterProducer {
    ...
    */
	...
	public KafkaProducer<String,String> createKafkaProducer() {
		...
		// properties.setProperty(ProducerConfig.BUFFER_MEMORY_CONFIG, "32"); Wielkosc buffera - domyslnie 32MB, po zapelmnieniu send() jest blokowany.
